...
/**
 * Flips an image either horizontally or vertically determined by 'direction' option
 * 
 * @author Kristoffer Hansen <kriz@motnok.dk>
 */
class FlipPlugin implements PluginInterface
{
	...
	protected $_options = array(
		'direction' => FlipableInterface::DIRECTION_HORIZONTAL
	);
	
	/**
	 * Crate a new FlipPlugin instance
	 * 
	 * @param array $options
	 */
	...
	{
		if(!$current instanceof FlipableInterface) 
			return;
			
		$current->flip($this->_options['direction']);
	}
